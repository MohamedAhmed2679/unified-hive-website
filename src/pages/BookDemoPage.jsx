...
"I personally oversee our enterprise architecture reviews. My goal is to ensure your technology stack isn't just secure, but a competitive advantage."
 ...
 <span key={tag} className="bg-gray-100 dark:bg-[#001F3F] text-[#001F3F] dark:text-white text-xs font-semibold px-3 py-1 rounded-full border border-transparent dark:border-white/20">
 {tag}
 </span>
 ))}
 </div>
