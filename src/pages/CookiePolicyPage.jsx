...
const CookiePolicyPage = () => {
 ...
 <h1 className="text-3xl font-bold text-[#001F3F] dark:text-white mb-8 font-heading">Cookie Policy</h1>
 ...
 <section>
 <h2 className="text-xl font-semibold text-[#001F3F] dark:text-white mb-3 font-heading">1. What Are Cookies</h2>
 ...
 <section>
 <h2 className="text-xl font-semibold text-[#001F3F] dark:text-white mb-3 font-heading">2. How We Use Cookies</h2>
 ...
 <section>
 <h2 className="text-xl font-semibold text-[#001F3F] dark:text-white mb-3 font-heading">3. Disabling Cookies</h2>
 ...
 <section>
 <h2 className="text-xl font-semibold text-[#001F3F] dark:text-white mb-3 font-heading">4. Third Party Cookies</h2>
