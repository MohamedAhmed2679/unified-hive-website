...
const PrivacyPolicyPage = () => {
 ...
 <h1 className="text-3xl font-bold text-[#4A142C] mb-8 font-heading">Privacy Policy</h1>
 ...
 <section>
 <h2 className="text-xl font-semibold text-[#4A142C] mb-3 font-heading">1. Introduction</h2>
 ...
 <section>
 <h2 className="text-xl font-semibold text-[#4A142C] mb-3 font-heading">2. Information We Collect</h2>
 ...
 <section>
 <h2 className="text-xl font-semibold text-[#4A142C] mb-3 font-heading">3. How We Use Your Information</h2>
 ...
 <section>
 <h2 className="text-xl font-semibold text-[#4A142C] mb-3 font-heading">4. Disclosure of Your Information</h2>
 ...
 <section>
 <h2 className="text-xl font-semibold text-[#4A142C] mb-3 font-heading">5. Contact Information</h2>
