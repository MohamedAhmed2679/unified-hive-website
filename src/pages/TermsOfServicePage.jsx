...
const TermsOfServicePage = () => {
 ...
 <h1 className="text-3xl font-bold text-[#001F3F] dark:text-white mb-8 font-heading">Terms of Service</h1>
 ...
 <section>
 <h2 className="text-xl font-semibold text-[#001F3F] dark:text-white mb-3 font-heading">1. Acceptance of the Terms of Service</h2>
 ...
 <section>
 <h2 className="text-xl font-semibold text-[#001F3F] dark:text-white mb-3 font-heading">2. Changes to the Terms of Service</h2>
 ...
 <section>
 <h2 className="text-xl font-semibold text-[#001F3F] dark:text-white mb-3 font-heading">3. Accessing the Website and Account Security</h2>
 ...
 <section>
 <h2 className="text-xl font-semibold text-[#001F3F] dark:text-white mb-3 font-heading">4. Intellectual Property Rights</h2>
 ...
 <section>
 <h2 className="text-xl font-semibold text-[#001F3F] dark:text-white mb-3 font-heading">5. Governing Law</h2>
